...
CORS_ALLOWED_ORIGINS = [
    ...
    for origin in os.getenv(
        "CORS_ALLOWED_ORIGINS",
        "http://localhost:3000,http://127.0.0.1:3000,http://localhost:5173,http://127.0.0.1:5173,https://ceema.onrender.com",
    ).split(",")
    if origin.strip()
]
...
GMAIL_SENDER_EMAIL = os.getenv("GMAIL_SENDER_EMAIL", SMTP_USERNAME)
GMAIL_FROM_NAME = os.getenv("GMAIL_FROM_NAME", "CEEMA")
